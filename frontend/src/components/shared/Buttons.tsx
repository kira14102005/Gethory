...
export function LoginSubmitButton(props: ButtonProps) {
    return <>
        <button className="bg-[#0B1D23] border border-[#4A5568] p-1 rounded-md flex flex-row justify-center items-center w-full  hover:bg-opacity-75 transition duration-500 ease-in-out">
            <div className="flex flex-row w-fit items-center ">
